...
import setloading from "./_components/CustomLoading";
...
function CreateNew() {
  try {
    ...
    const [audiCaption, setAudioCaption] = useState();
    ...
    const GenerateAudioFile = async (videoScriptData) => {
      ...
      try {
        ...
        response.data.audioFileUrl &&
          GenerateAudioCaption(response.data.audioFileUrl, videoScriptData);
      } catch (error) {
    ...
    const GenerateAudioCaption = async (fileUrl, videoScriptData) => {
      ...
      setAudioCaption(response?.data?.result); // setCaption tha pehle
